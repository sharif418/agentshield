...
function parseConditionRules(
  conditionRules: string | ConditionRule | Record<string, unknown> | null | undefined
  ...
  return conditionRules as Record<string, unknown>;
}
...
export function evaluatePolicies(
  ...
  let matchedPolicy: EvaluateResult['matchedPolicy'] = null;
  ...
  if (action) {
    ...
    // Zero-trust mode
    const blockPolicies: Policy[] = [];
    const approvalPolicies: Policy[] = [];
